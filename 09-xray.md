...
- **Traefik / CrowdSec (`192.168.40.11`)** — потребитель forward-прокси (`10809`) для скачивания плагина, namecheap-ACME и CAPI-синхронизации (см. `07-traefik.md`).
