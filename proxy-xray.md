...
Прозрачное проксирование: телевизоры (сегмент IOT) не поддерживают ручную настройку прокси, поэтому их трафик заворачивается на Xray на уровне маршрутизации OPNsense, без настройки на самих устройствах. На Xml-VM трафик перехватывается через nat-REDIRECT и попадает в transparent-inbound.
