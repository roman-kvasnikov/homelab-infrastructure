...
**OPNsense (101)** — маршрутизатор и firewall сети. `net0` → `vmbr0` (WAN), `net1` → `vmbr1` (LAN-транк со всеми VLAN). CPU type `host`, virtio-сеть, hardware offload отключён. Детали — в `03-network.md` и `vpn-amneziawg.md`.
