...
### 11.1. Бэкап-сервер (192.168.1.11)
...
### 11.2. Уровень 1: VM и LXC через PBS
...
### 11.3. Уровень 2: Конфигурация pve-хоста через PBS host backup
...
### 11.4. Уровень 3: Данные внутри DockerHost через restic
...
### 11.7. Сценарий полного восстановления
