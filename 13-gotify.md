...
Только PBS-снапшот всего LXC в составе общего pve-задания. Критичного point-in-time состояния, ради которого нужен отдельный гранулярный бэкап (как БД паролей у Vaultwarden или TOTP/OIDC у Authelia), у Gotify нет — SQLite с подписками и историей сообщений некритична, а file-level restore одного файла из CT-снапшота PBS при необходимости доступен. См. `06-backup.md`.
